...
if count > maxpackage_zips or int(total_sizetext) > filesize:
	choice2 = xbmcgui.Dialog().yesno("Autolimpiar", 'La Carpeta packages tiene' + str(total_sizetext) +' MB  - ' + str(count) + 'zips', 'La carpeta se puede limpiar sin problemas para ahorrar espacio ...', 'las eliminamos?', yeslabel='Si',nolabel='No')
	if choice2 == 1:
...
if int(total_sizetext2) > filesize_thumb:
	choice2 = xbmcgui.Dialog().yesno("AutoLimpiar", 'La Carpeta imagenes tiene' + str(total_sizetext2) + ' MB   ', 'La carpeta se puede limpiar sin problemas para ahorrar espacio ...', 'las eliminamos?', yeslabel='Si',nolabel='No')
	if choice2 == 1:
